...
for f = 1:length(imageFileList)
    ...
    % output pyramid
    outFName = fullfile(dataBaseDir, sprintf('%s_pyramid_llc_%d_%d_%d_%s.mat', ...
        baseFName, params.gridSpacing, params.dictionarySize, params.pyramidLevels, params.dictionaryType));
