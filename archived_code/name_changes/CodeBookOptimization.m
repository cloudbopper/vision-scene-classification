...
inFName = fullfile(dataBaseDir, sprintf('dictionary_%d_%d_%s.mat', params.gridSpacing, params.dictionarySize, 'k-means'));
...
outFName = fullfile(dataBaseDir, sprintf('dictionary_%d_%d_%s.mat', params.gridSpacing, params.dictionarySize, params.dictionaryType));
