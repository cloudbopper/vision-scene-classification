...
outFName = fullfile(data_dir, sprintf('dictionary_%d_%d_%s.mat', ...
...
defaultFName = fullfile(data_dir, sprintf('dictionary_%d.mat', params.dictionarySize));
movefile(defaultFName, outFName);